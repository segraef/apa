...
docker build --rm -f "PipelineAgents/2020-01-09/dockerfile" -t apa_ubuntu .
#docker build --rm -f "PipelineAgents/2020-01-09/dockerfile" -t apa_debian .
#docker build --rm -f "PipelineAgents/2020-01-09/dockerfile" -t apa_servercore .
...
# docker run -e AZP_URL="$url" -e AZP_TOKEN_FILE="\azp\.token" -e AZP_POOL="$agentPool" apa_sdebian
